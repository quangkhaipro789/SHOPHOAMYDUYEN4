			...
			<nav class="navbar navbar-expand-lg navbar-light bg-light">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav ml-auto text-center mr-xl-5">
						<li class="nav-item mr-lg-2 mb-lg-0 mb-2 <?php echo isset($_GET['quanly'])?'':'active'?>">
						...
						<?php 
							...
							while($row_category_danhmuc = mysqli_fetch_array($sql_category_danhmuc)){
								if(isset($_GET['quanly']) && isset($_GET['id']) && $_GET['id'] == $row_category_danhmuc['category_id']){
									$active = 'active';
								}else{
									$active = "";
								}
						?>
						<li class="nav-item  mr-lg-2 mb-lg-0 mb-2 <?php echo $active; ?>">
