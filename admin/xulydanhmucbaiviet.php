	...
	<div class="container-fluid">
		<div class="row">
			...
			if(isset($_GET['quanly'])=='capnhat'){
				...
				<form action="" method="POST" class="d-flex align-items-center mb-4">
					...
					<input type="submit" name="capnhatdanhmuc" value="Cập nhật danh mục" class="btn btn-primary ml-3">
				</form>
				</div>
			<?php
			}else{
				...
				<form action="" method="POST" class="d-flex align-items-center mb-4">
					...
					<input type="submit" name="themdanhmuc" value="Thêm danh mục" class="btn btn-primary ml-3">
				</form>
				</div>
				<?php
			} 
				   ...
				   <?php
					...
					<table class="table table-bordered table-striped">
						...
						<tr>
							...
							<td><a href="?xoa=<?php echo $row_category['danhmuctin_id'] ?>" class="btn btn-warning">Xóa</a>
								<a href="?quanly=capnhat&id=<?php echo $row_category['danhmuctin_id'] ?>" class="btn btn-success">Cập nhật</a></td>
						</tr>
						<?php
						} 
						?>
