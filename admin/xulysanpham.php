			...
			<?php
				...
				<form action="" method="POST" enctype="multipart/form-data">
					<div class="row">
						...
						<div class="col-sm-12 col-md-6 col-lg-4">
							<input type="submit" name="themsanpham" value="Thêm sản phẩm" class="btn btn-primary mb-3">
						</div>
					</div>
				    ...
				    <?php
						...
						<table class="table table-bordered table-striped">
							...
							<tr>
								...
								<td><a class="btn btn-warning" href="?xoa=<?php echo $row_sp['sanpham_id'] ?>" class="mr-3">Xóa</a>
									<a class="btn btn-success" href="xulysanpham.php?quanly=capnhat&capnhat_id=<?php echo $row_sp['sanpham_id'] ?>">Cập nhật</a></td>
							</tr>
						<?php
							} 
							?> 
