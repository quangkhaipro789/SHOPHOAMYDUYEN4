				...
				<form action="" method="POST" enctype="multipart/form-data">
					<div class="row">
						...
						<div class="col-sm-12 col-md-12 col-lg-12">
							<input type="submit" name="capnhatbaiviet" value="Cập nhật bài viết" class="btn btn-primary mb-4">
						</div>
					</div>
			...
			<?php
				...
				<form action="" method="POST" enctype="multipart/form-data">
					<div class="row">
						...
						<div class="col-sm-12 col-md-12 col-lg-12">
							<input type="submit" name="thembaiviet" value="Thêm bài viết" class="btn btn-primary mb-3">
						</div>
					</div>
				</form>
				</div>
